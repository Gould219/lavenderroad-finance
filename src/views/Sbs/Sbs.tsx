...
const Sbs: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(tombFinance.LBURGER, tombFinance.contracts.TShareSwapper.address);
                      ...
                      <Card>
                        <CardContent>
                          <StyledCardContentInner>
                            <StyledCardTitle>Lburgers</StyledCardTitle>
                            <StyledExchanger>
                              <StyledToken>
                                <StyledCardIcon>
                                  <TokenSymbol symbol={tombFinance.LBURGER.symbol} size={54} />
                                </StyledCardIcon>
                              </StyledToken>
                            </StyledExchanger>
                            <Grid item xs={12}>
                            ...
                            <StyledDesc>{`${bondBalance} LBURGER Available in Wallet`}</StyledDesc>
                          </StyledCardContentInner>
                        </CardContent>
                      </Card>
                    </StyledCardWrapper>
